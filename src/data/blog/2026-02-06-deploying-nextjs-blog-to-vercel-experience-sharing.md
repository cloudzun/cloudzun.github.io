...
- `app/posts/[slug]/page.js` - 单篇文章页
- `content/posts/` - 存放Markdown文章
- `lib/posts.js` - 文章处理逻辑
...
- **样式**: Tailwind CSS
- **内容处理**: gray-matter, remark/rehype
- **部署平台**: Vercel
...
- **生产环境**: https://new-vercel-blog.vercel.app
- **项目别名**: https://new-vercel-blog-knlo6y3mi-cloudzuns-projects.vercel.app
