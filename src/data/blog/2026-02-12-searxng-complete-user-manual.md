...
description: 'SearxNG 完整使用手册 版本： 3.0-enhanced
发布日期： 2026-02-12
状态： ✅ 生产环境可用
'
...
curl
"http://127.0.0.1:8765/search?q=python&api_key=
$API_KEY
"
|
jq .
...
1
curl
"http://127.0.0.1:8765/search?q=QUERY&api_key=KEY"
参数说明：
参数
必填
说明
...
1
curl
"http://127.0.0.1:8765/search?q=python&sort=relevance&api_key=KEY"
最相关的结果优先
适合：查找最相关的信息
性能：最快
日期排序
1
curl
"http://127.0.0.1:8765/search?q=AI+news&sort=date&api_key=KEY"
最新的内容优先
适合：查找最新新闻、文章
性能：中等
域名排序
1
curl
"http://127.0.0.1:8765/search?q=python&sort=domain&api_key=KEY"
按域名分组，同一网站的结果聚在一起
适合：浏览不同网站的内容
性能：中等
2️⃣ 过滤功能 (Filtering)
...
curl
"http://127.0.0.1:8765/search?q=python+async&\
...
# 排除社交媒体和垃圾网站
curl
"http://127.0.0.1:8765/search?q=python&\
...
# 只显示中文结果
curl
"http://127.0.0.1:8765/search?q=python&languages=zh&api_key=KEY"
# 显示英文和日文
curl
"http://127.0.0.1:8765/search?q=machine+learning&\
...
# 只显示最近 7 天的结果
curl
"http://127.0.0.1:8765/search?q=AI+news&days=7&api_key=KEY"
# 只显示最近 30 天的结果
curl
"http://127.0.0.1:8765/search?q=python+release&days=30&api_key=KEY"
去重和去垃圾
1
2
3
# 移除重复的 URL 和垃圾内容
curl
"http://127.0.0.1:8765/search?q=test&\
...
6
curl
"http://127.0.0.1:8765/search?q=AI+news&\
sort=date&\
days=7&\
...
快速搜索脚本
创建文件：
/home/chengzh/bin/searxng-search.sh
1
2
3
4
...
print
(
"Usage: searxng.py <query> [sort] [domains] [languages]"
)
sys
.
exit
...
# 技术文档搜索
curl
"http://127.0.0.1:8765/search?q=QUERY&sort=relevance&domains=github.com,stackoverflow.com&api_key=KEY"
# 最新新闻搜索
curl
"http://127.0.0.1:8765/search?q=QUERY&sort=date&days=7&api_key=KEY"
# 多语言搜索
curl
"http://127.0.0.1:8765/search?q=QUERY&languages=en,zh&api_key=KEY"
# 高质量搜索
curl
"http://127.0.0.1:8765/search?q=QUERY&remove_spam=true&remove_duplicates=true&api_key=KEY"
常用域名
1
2
3
...
# 确认 Key 正确后重试
curl
"http://127.0.0.1:8765/search?q=test&api_key=YOUR_KEY"
...
# 简化查询词
curl
"http://127.0.0.1:8765/search?q=python&api_key=KEY"
🚀 下一步
立即可做
✅ 书签本手册
✅ 保存 API Key
