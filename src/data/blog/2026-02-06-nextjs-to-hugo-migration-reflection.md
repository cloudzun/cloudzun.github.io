...
description: '前言 这是一个关于"绕了一大圈才发现最简单的方案就在眼前"的真实故事。如果你也曾在技术选型上犹豫不决，在自己造轮子和使用成熟方案之间纠结，那么这篇文章或许能给你一些启发。
'
...
这个决定让我陷入了一个漫长的坑：
手工复刻 CSS
: 尝试用 Tailwind 工具类重写 Hugo Paper 的样式
细节调整无穷无尽
: 间距、字号、行高、颜色…每个细节都需要反复调试
代码膨胀
:
app/globals.css
膨胀到 370+ 行自定义样式
...
为什么会绕这么大的圈？
技术栈惯性
: “我熟悉 React，所以用 Next.js”
过度工程化
: “我可以自己实现"的自信
忽视成本
: 没有充分评估定制开发的时间成本
目标模糊
: 混淆了"学习技术"和"完成项目"两个目标
正确的思考方式
在开始项目前，应该问自己：
核心需求是什么？
...
项目地址
:
https://github.com/cloudzun/clean-vercel-blog
技术栈
: Hugo v0.147.7 Extended + FixIt Theme + Vercel
教训
: 别和自己过不去，用现成的！😄