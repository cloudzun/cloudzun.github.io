...
该论文提供了构建自主 LLM 智能体的**完整架构框架**，包含四个关键系统：
...
- 自主性来自于这四个系统的**有机整合**
- 每个系统都模拟人类认知过程的某个方面
- 系统间的**反馈循环**是实现自主学习的关键

**启示**: 构建自主智能体不是简单地使用 LLM，而是需要**系统性的架构设计**。
...
这是该领域的**开创性综述**，提供了 LLM 基础自主智能体的**系统性框架**。
...
虽然主要讨论多智能体系统，但提供了**单个自主智能体在企业环境中的设计原则**。
...
解决 LLM 智能体框架的**供应商锁定问题**，提供跨供应商的统一接口。
...
自主智能体技术正处于**快速发展的关键时期**。这五篇论文代表了该领域从基础理论到工程实现的完整进化。
...
未来的自主智能体将不再是孤立的工具，而是**智能、自适应、可信赖的系统伙伴**。
