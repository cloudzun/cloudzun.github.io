...
tags: ['api', 'rate-limiting', 'inference', 'databricks', 'claude']
---

OpenClaw API 限制参数推断报告
报告生成时间
: 2026-02-14 12:40 UTC
分析周期
: 过去 96 小时（2026-02-10 - 2026-02-14）
样本数据
: 46 条 429 错误记录
📊 执行摘要
参数
...
置信度
每分钟 Token 限制
60,000 - 100,000 tokens/min
🟢 高
时间窗口
60 秒（滑动窗口）
🟢 高
Token 补充速率
1,000 - 1,667 tokens/秒
🟡 中
恢复时间
~60 秒
🟢 高
